...
- Interface gate: ux-interaction owns flow, navigation, interaction semantics, and IA; visual-design owns visual system, typography, imagery, iconography, and art direction; web-presentation owns responsive layout, states, motion, and browser polish; accessibility owns inclusive-use constraints; implementation codes approved decisions without inventing any of those decisions.
