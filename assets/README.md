...
Public-safe infographic assets for the Subagent Operating Model.

- `subagent-operating-model-demo-opener.svg` /
  `subagent-operating-model-demo-opener.png` - 16:9 video opener infographic.
